...
namespace CarpoolSystem.Services
{
    public class DatabaseManager
    {
        ...
        {
            void createEvent(string title, string startingAddress, string startingCity, string startingState, string destAddress,
                string destCity, string destState, string startingTime, string EndingTime, string eventInfo, string days);

            void newCar(string carMake, string carModel, string carColor, Int32 carYear, Int32 totalSeats);

            void newDriver(string userName);

            void newPassenger(string userName, int eventId);

            void saveChanges();

            //IQueryable<T> Query { get; }
        }
        public class dbInteraction : IRepository<MainDbEntities>
        {
                ...
                string destCity, string destState, string startingTime, string EndingTime, string eventInfo, string days)
            {
                ...
                newEvent.EndingAddress = destAddress;
